...
export FOD_PACKAGE_RELEASE="${FOD_PACKAGE_RELEASE:-2}"
export FOD_PACKAGE_MAINTAINER="${FOD_PACKAGE_MAINTAINER:-FOD Project <33524981+stachwk@users.noreply.github.com>}"
