...
2026-01-01T00:00:03Z - INFO -   pg_prepared_statement name=fod_fetch_block_range count=4 total_us=200000 max_us=60000 avg_us=50000 params=12 param_bytes=24 result_rows=512 result_bytes=2097152 failures=0
2026-01-01T00:00:03Z - INFO -   pg_result_decode name=fod_fetch_block_range count=4 total_us=30000 max_us=9000 avg_us=7500 result_rows=512 result_bytes=2097152 failures=0
...
grep -Fq 'profile_attribution_available=1' <<<"${OUT}"
grep -Fq 'fetch_block_range_calls=4' <<<"${OUT}"
grep -Fq 'fetch_block_range_result_bytes=2097152' <<<"${OUT}"
grep -Fq 'pg_operations_per_callback=2.500000' <<<"${OUT}"
grep -Fq 'fetch_calls_per_callback=0.500000' <<<"${OUT}"
grep -Fq 'fetch_rows_per_call=128.000000' <<<"${OUT}"
grep -Fq 'fetch_bytes_per_call=524288.000000' <<<"${OUT}"
grep -Fq 'fetch_bytes_per_callback=262144.000000' <<<"${OUT}"
grep -Fq 'read_block_map_us_per_callback=45000.000000' <<<"${OUT}"
grep -Fq 'repo_fetch_block_range_us_per_callback=35000.000000' <<<"${OUT}"
grep -Fq 'pg_fetch_us_per_callback=25000.000000' <<<"${OUT}"
grep -Fq 'pg_decode_us_per_callback=3750.000000' <<<"${OUT}"
grep -Fq 'non_fetch_operation_count=16' <<<"${OUT}"
