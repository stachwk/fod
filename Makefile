...
FIFO_FUSE_FAIRNESS_LARGE_BYTES ?= 4194304
FIFO_FUSE_FAIRNESS_LARGE_CHUNK_BYTES ?= 4096
FIFO_FUSE_FAIRNESS_LARGE_PACE_MS ?= 0.5
FIFO_FUSE_FAIRNESS_MINIMUM_LARGE_DURATION_MS ?= 300
FIFO_FUSE_FAIRNESS_SMALL_FILES ?= 24
FIFO_FUSE_FAIRNESS_SMALL_BYTES ?= 4096
FIFO_FUSE_FAIRNESS_OVERLAP_MIN_PERCENT ?= 90
FIFO_FUSE_FAIRNESS_TIMEOUT_SECONDS ?= 120
...
test-fifo-fuse-fairness: init
	...
	FIFO_FUSE_FAIRNESS_LARGE_BYTES="$(FIFO_FUSE_FAIRNESS_LARGE_BYTES)" \
	FIFO_FUSE_FAIRNESS_LARGE_CHUNK_BYTES="$(FIFO_FUSE_FAIRNESS_LARGE_CHUNK_BYTES)" \
	FIFO_FUSE_FAIRNESS_LARGE_PACE_MS="$(FIFO_FUSE_FAIRNESS_LARGE_PACE_MS)" \
	FIFO_FUSE_FAIRNESS_MINIMUM_LARGE_DURATION_MS="$(FIFO_FUSE_FAIRNESS_MINIMUM_LARGE_DURATION_MS)" \
