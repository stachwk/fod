...
The normal Make interface pins the client to the exact `fod_version.txt` release. For FOD 3.4.6:
...
```bash
FOD_DOCKER_DEPLOY_CLIENT_IMAGE=ghcr.io/stachwk/fod-client:3.4.6 \
