...
For normal repository-driven builds, the image is tagged with the exact FOD source release from `fod_version.txt`. For FOD 3.4.17 the immutable source-build image is:

```text
ghcr.io/stachwk/fod-client:3.4.17
```
