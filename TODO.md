...
- [ ] Optimize the next measured 128 MiB block-only bottleneck after FOD 3.2.77: COPY BINARY staging plus the `data_blocks` set-based merge under mounted FUSE writes.
