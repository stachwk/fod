...
- [ ] Deliver the remaining Compatibility and FUSE Modernization follow-ups without reopening the completed Storage Engine v2 implementation.
  ...
  - [ ] Revisit `fuser 0.18.0` compatibility as a separate capability-maintenance pass. Crates.io exposes a newer fuser release, but FOD currently pins `0.17.0` with explicit `abi-7-40` and `libfuse3`; any upgrade must rerun the FUSE compatibility matrix instead of being folded into unrelated work.
