...
- [ ] Use the extended DML and IO/WAL reports to collect a fresh local/QNAP baseline plus COPY buffer matrix before changing server-side `COPY` or the target-table merge.
